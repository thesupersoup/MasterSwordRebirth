...
enum
{
	...
	SKILL_NONCOMBAT,
	SKILL_MAX_ATTACK = SKILL_NONCOMBAT + 1, //Max number of attack skills (MiB JUL2010_02 - Again)
										   //	SKILL_SPELLPREPARING,
										   //	SKILL_SWIMMING,
										   //	SKILL_THEFT,

	SKILL_LASTSKILL = SKILL_NONCOMBAT, //MiB JUL2010_02 - And again..
...
enum
{
	...
	STAT_NCSKILL_WOODCUTTING = 0,
	STAT_NCSKILL_MINING,
	STAT_NCSKILL_CRAFTING,
	STAT_NCSKILL_BLACKSMITHING,
	STAT_NCSKILL_APOTHECARY,
	STAT_NCSKILL_FORAGING,
	STAT_NCSKILL_TRACKING,
	STAT_NCSKILL_FATEWEAVING,
	STAT_NCSKILL_FLETCHING,
	STAT_NCSKILL_THIEVING,
	STAT_NCSKILL_BARDICLORE,
	STAT_NCSKILL_BARTERING,
	STAT_NCSKILL_TOTAL,

	STATPROP_ALL_TOTAL = STAT_NCSKILL_TOTAL + STAT_MAGIC_TOTAL,
};
